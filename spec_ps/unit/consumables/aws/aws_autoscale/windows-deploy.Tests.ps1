...
$scriptPath = "$currentDir/lib/consumables/aws/aws_autoscale/windows-deploy.ps1"
...
Describe 'windows-deploy.ps1' {
    ...
    Context 'Execution' {
        ...
        function Mock-Execution() {
            ...
            function Get-CfnMetadata {}

            Mock -CommandName Get-CfnMetadata  -MockWith { return 'cfn-metadata-resource' }
